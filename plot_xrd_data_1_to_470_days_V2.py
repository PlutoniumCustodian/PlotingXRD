...
xrd_quad_plot(Al_axial, Data_lable , ColorPalet_1,\
              'Al_axial_1to470day_forACerS','Moderate-Al', off_set)
...
xrd_quad_plot(Al_corner , Data_lable , ColorPalet_1,\
              'Al_corner_1to470day_forACerS', 'High-Al', 13500)
# Uncomment this line to save the figure.
# fig.savefig('Plots/AL_halfmL_to_1g.svg', transparent=False, bbox_inches="tight")
...
xrd_quad_plot(P_free , Data_lable , ColorPalet_1, 'PO4_free_1and28_day_forACerS',\
              'Phosphate-Free', 7000)
# Uncomment this line to save the figure.
# fig.savefig('Plots/AL_halfmL_to_1g.svg', transparent=False, bbox_inches="tight")
