...
datpath = 'Files_organized_for_plots/PO4_interculated_LDH_nitrate_method' # directory where data is 
...
XRDdata = []
#Name your data
XRD_label = [ 'Bouhacha 2005', 'Original', 're-intercalated']
...
off_set = 0 #1500 #used to shift graphs up or down
lnthikness= 1
xlimits = [ 5, 65]
ylimits = [.25, 3]
...
xrd_quad_plot(XRDdata, XRD_label, ColorPalet_1, 'Nitrate_based_PO4LDH', '')
