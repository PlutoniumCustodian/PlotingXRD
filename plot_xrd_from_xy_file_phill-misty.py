...
datpath = 'Files_organized_for_plots/Phill-Misty/' # directory where data is 
...
XRDdata = []
#Name your data
XRD_label = [ 'Water washed centroid','5.7 M NaOH', '8.33M NaOH', ]
...
xrd_quad_plot(XRDdata, XRD_label, ColorPalet_1, 'Making_Phill-Misty_stacked', '')
