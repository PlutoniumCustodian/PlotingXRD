# -*- coding: utf-8 -*-
"""
Created on Tue Apr 25 21:37:45 2023
...
def xrd_single_plot(xrd_data, plot_names, svg_file_name, plt_title,n):
    ...
    svg_name_path = 'Plots/Single_plots' + svg_file_name[n] + '.svg'
    # Uncomment this line to save the figure.
    # fig.savefig(svg_name_path, transparent=False, bbox_inches="tight")
    return fig
#%% Ploting XRD data
num_of_scans = range(len(np.array(XRDdata)))    
for n in num_of_scans:
    xrd_single_plot(XRDdata, XRD_label, XRD_label, XRD_label, n)